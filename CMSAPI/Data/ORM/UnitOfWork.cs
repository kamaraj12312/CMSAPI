...
namespace EndocPM.WebAPI
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(HmsDbcontext _dbcontext, IHttpContextAccessor _httpContextAccessor)
        {
            dbcontext = _dbcontext;
            httpContextAccessor = _httpContextAccessor;
        }
        public HmsDbcontext context => dbcontext;
        ...
        //        audit.AuditDate = DateTime.Now.ToUniversalTime();
        //        audit.Action = action;
        ...
        public async Task SaveAsync()
        {
            ...
            //   await OnAfterChangesAsync(auditEntries);
        }
